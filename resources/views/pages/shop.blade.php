					...
					<div class="row">
						...
						<div class="side-bar col-lg-3">
							<div class="search-hotel">
								<h3 class="agileits-sear-head">Tìm Kiếm Tại Đây..</h3>
								<form action="#" method="post">
							...
							<div class="wrapper_top_shop">
								<div class="row">
										<div class="col-md-6 shop_left">
												<img src="{!! asset('public/pages/images/banner3.png')!!}" alt="">
												<h6>Giảm 20%</h6>
											</div>
											<div class="col-md-6 shop_right">
												<img src="{!! asset('public/pages/images/banner4.png')!!}" alt="">
												<h6>Giảm 10%</h6>
											</div>
                                                    ...
                                                    <div class="men-thumb-item">
                                                        ...
                                                        <div class="men-cart-pro">
                                                            <div class="inner-men-cart-pro">
                                                                <a href="{{route('pages.detail_pro',$pro->id)}}" class="link-product-add-cart">Chi Tiết</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="info-product-price">
                                                            <div class="grid_meta">
                                                                <div class="product_price">
                                                                    <h4>
                                                                        <a href="{{route('pages.single')}}">{{$pro->name}}</a>
                                                                    </h4>
                                                                    <div class="grid-price mt-2">
                                                                        <span class="money ">{{number_format($pro->price)}}</span>
                                                                    </div>
                                                                </div>
